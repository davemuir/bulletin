...
$tz_author_bio = get_option('tz_author_bio');
$tz_show_related = get_option('tz_show_related');
$tz_related_type = get_option('tz_related_type');
$tz_related_number = get_option('tz_related_number');
            ...
            <div class="grid_8" id="archive">
                ...
                <div class="grid_8 alpha omega">
                    ...
                    <div id="author">
                        ...
                        <div class="image"><?php echo get_avatar( get_the_author_meta('email'), '80' ); ?></div>
