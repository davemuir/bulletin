...
$tz_cat_four_select = get_option('tz_cat_four_select');
$tz_cat_four_number = get_option('tz_cat_four_number');

?>

<?php /* Category credentials */
$category_id = $tz_cat_four_select;
...
<div class="category_list">
    ...
    <ul>
    	<?php 
		$query = new WP_Query();
		$query->query('ignore_sticky_posts=1&posts_per_page=' . $tz_cat_four_number . '&cat=' . $category_id);
