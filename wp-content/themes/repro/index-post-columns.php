...
<div class="post_columns">
    ...
    <div class="column <?php if( $i == 8 || $i == 4) : ?>last<?php endif; ?>">
        ...
        <div class="date"><?php the_time( get_option('date_format') ); ?>,<br/><?php the_category('$separator'); ?> ,<?php comments_popup_link(__('No comments', 'framework'), __('1 Comment', 'framework'), __('% Comments', 'framework')); ?></div>
