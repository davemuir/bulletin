...
$tz_cat_three_select = get_option('tz_cat_three_select');
$tz_cat_three_number = get_option('tz_cat_three_number');

?>

<?php /* Category credentials */
$category_id = $tz_cat_three_select;
...
<div class="category_list">
    ...
    <ul>
    	<?php 
		$query = new WP_Query();
		$query->query('ignore_sticky_posts=1&posts_per_page=' . $tz_cat_three_number . '&cat=' . $category_id);
